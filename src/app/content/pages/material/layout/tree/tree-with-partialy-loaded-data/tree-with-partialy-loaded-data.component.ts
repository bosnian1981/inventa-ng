...
@Component({
  selector: 'app-tree-with-partialy-loaded-data',
  templateUrl: './tree-with-partialy-loaded-data.component.html',
  styleUrls: ['./tree-with-partialy-loaded-data.component.scss'],
  providers: [LoadmoreDatabase],
  encapsulation: ViewEncapsulation.None
})
export class TreeWithPartialyLoadedDataComponent implements OnInit {
